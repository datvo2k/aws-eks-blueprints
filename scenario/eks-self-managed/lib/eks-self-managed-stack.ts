...
import { Cluster, KubernetesVersion, NodeType, EksOptimizedImage } from 'aws-cdk-lib/aws-eks';
...
export class EksSelfManagedStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    workerRole.addManagedPolicy(ManagedPolicy.fromAwsManagedPolicyName('AmazonEKSClusterPolicy'))
    workerRole.addManagedPolicy(ManagedPolicy.fromAwsManagedPolicyName('AmazonEKSServicePolicy'))
